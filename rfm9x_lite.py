...
This does not implemnt any packet header and is not compatible with the RadioHead library.
It should be compatible with the arduino-lora library:
...
__repo__ = "https://github.com/jerryneedell/rfm9x_lite.git"
...
class RFM9x:
    ...
    def send(
        ...
        *,
        ...
        self._write_u8(_RH_RF95_REG_22_PAYLOAD_LENGTH, len(data))
